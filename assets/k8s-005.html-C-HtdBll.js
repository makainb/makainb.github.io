import{_ as n,o as s,c as e,a}from"./app-CdIUVeFa.js";const i={},l=a(`<p>master-01节点 初始化配置文件</p><div class="language-yaml line-numbers-mode" data-highlighter="prismjs" data-ext="yml" data-title="yml"><pre class="language-yaml"><code><span class="line">vim kubeadm<span class="token punctuation">-</span>config.yaml</span>
...
<span class="line"></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div></div></div>`,24),t=[l];function c(p,o){return s(),e("div",null,t)}const d=n(i,[["render",c],["__file","k8s-005.html.vue"]]),u=JSON.parse('{"path":"/docs/ops/k8s-005.html","title":"","lang":"en-US","frontmatter":{},"headers":[],"git":{"createdTime":1720989410000,"updatedTime":1721062027000,"contributors":[{"name":"makai","email":"makai3@126.com","commits":2}]},"filePathRelative":"docs/ops/k8s-005.md"}');export{d as comp,u as data};
