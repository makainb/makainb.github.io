import{_ as n,c as a,a as e,o as l}from"./app-BBfrr_IE.js";const i={};function p(c,s){return l(),a("div",null,s[0]||(s[0]=[e(`<h1 id="证书有效期续99年" tabindex="-1"><a class="header-anchor" href="#证书有效期续99年"><span>证书有效期续99年</span></a></h1><p>注：推荐大家一年更新一次k8s版本</p><h2 id="证书更新-一年" tabindex="-1"><a class="header-anchor" href="#证书更新-一年"><span>证书更新(一年)</span></a></h2><div class="language-bash line-numbers-mode" data-highlighter="prismjs" data-ext="sh" data-title="sh"><pre class="language-bash"><code><span class="line"><span class="token comment"># 查看证书有效期</span></span>
