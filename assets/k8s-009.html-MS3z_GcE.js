import{_ as e,c as n,a,o as l}from"./app-Cl9giDyJ.js";const i={};function t(c,s){return l(),n("div",null,s[0]||(s[0]=[a(`<p>https://kubernetes.io/zh-cn/docs/reference/kubectl/quick-reference/</p><h2 id="安装自动补全" tabindex="-1"><a class="header-anchor" href="#安装自动补全"><span>安装自动补全</span></a></h2><div class="language-bash line-numbers-mode" data-highlighter="prismjs" data-ext="sh" data-title="sh"><pre class="language-bash"><code><span class="line"><span class="token comment"># 安装 &quot;bash-completion&quot; </span></span>
