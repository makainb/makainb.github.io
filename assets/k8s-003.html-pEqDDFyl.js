import{_ as n,c as e,a,o as i}from"./app-Cl9giDyJ.js";const l={};function p(d,s){return i(),e("div",null,s[0]||(s[0]=[a(`<h2 id="所有-master-节点安装-haprox-和-keepalived" tabindex="-1"><a class="header-anchor" href="#所有-master-节点安装-haprox-和-keepalived"><span>所有 master 节点安装 HAProx 和 Keepalived</span></a></h2><div class="language-text line-numbers-mode" data-highlighter="prismjs" data-ext="text" data-title="text"><pre class="language-text"><code><span class="line">yum install keepalived haproxy -y</span>
