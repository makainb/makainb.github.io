import{_ as s,o as e,c as n,a}from"./app-CdIUVeFa.js";const i={},l=a(`<h2 id="集群网段划分" tabindex="-1"><a class="header-anchor" href="#集群网段划分"><span>集群网段划分</span></a></h2><p>1/ 主机节点网段 192.168.1.0/24 2/ Service网段 10.96.0.0/16 3/ Pod网段 10.244.0.0/16</p><h2 id="服务器资源配置" tabindex="-1"><a class="header-anchor" href="#服务器资源配置"><span>服务器资源配置</span></a></h2><p>1/Mater节点 2C4G * 3</p><p>2/Node节点 2C4G * 3</p><h2 id="版本选择" tabindex="-1"><a class="header-anchor" href="#版本选择"><span>版本选择</span></a></h2><p>https://kubernetes.io/</p><h2 id="安装环境与工具" tabindex="-1"><a class="header-anchor" href="#安装环境与工具"><span>安装环境与工具</span></a></h2><p>工具：VMWare 、XShell 使用主机网段 VIP： master-01：2C2G，20G，桥接，删除声卡和打印机 master-02：2C2G，20G，桥接，删除声卡和打印机 master-03：2C2G，20G，桥接，删除声卡和打印机 node-01：2C2G，20G，桥接，删除声卡和打印机 node-02：2C2G，20G，桥接，删除声卡和打印机</p><p>2C2G 20G，桥接,删除声卡和打印机</p><p>IP地址设置成固定的</p><p>Service网段： Kubernetes Service 的IP地址是固定的 10.96.0.1 CoreDNS的IP地址是第十个IP地址 10.96.0.10</p><p>etcd cluster keepalived + haproxy (keepalived + nginx) k8s-master-01 k8s-master-02 k8s-master-03 k8s-node-01 k8s-node-02</p><p>0.修改 mac 1.修改 hostname /etc/hostname 2.修改 ip /etc/NetworkManager/system-connections/ens160.nmconnection 3.修改网卡UUID</p><div class="language-text line-numbers-mode" data-highlighter="prismjs" data-ext="text" data-title="text"><pre class="language-text"><code><span class="line"># 列出所有可用的网卡接口和其他信息</span>
